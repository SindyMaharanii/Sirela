    ...
    <?php elseif(!$lembaga): ?>
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-5 text-center">
                ...
                <a href="<?php echo e(route('lembaga.create')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#0f2b5c] via-[#1e3a8a] to-[#2563eb] hover:from-[#1e3a8a] hover:to-[#3b82f6] text-white rounded-lg transition shadow-md">
    ...
    <?php else: ?>
            ...
            <div class="bg-gradient-to-r from-[#0f2b5c] to-[#1e3a8a] rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold"><?php echo e($lembaga->informasi->jumlah_anak_asuh ?? 0); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold"><?php echo e(($lembaga->informasi->status_kolaborasi ?? '') == 'dibuka' ? 'Dibuka' : 'Ditutup'); ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <p class="font-semibold"><?php echo e($lembaga->nama_lembaga); ?></p>
                <p class="text-gray-500 text-sm mt-1"><i class="fas fa-map-marker-alt mr-2"></i> <?php echo e($lembaga->lokasi ?? $lembaga->alamat ?? '-'); ?></p>
                <p class="text-gray-500 text-sm"><i class="fas fa-phone mr-2"></i> <?php echo e($lembaga->kontak ?? '-'); ?></p>
                <a href="<?php echo e(route('lembaga.edit', $lembaga->lembaga_id)); ?>" class="inline-flex items-center gap-2 text-blue-600 text-sm mt-3 hover:underline">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <p><i class="fas fa-child mr-2"></i> Jumlah Anak: <?php echo e($lembaga->informasi->jumlah_anak_asuh ?? 0); ?></p>
                <p class="mt-1"><i class="fas fa-calendar mr-2"></i> Update Terakhir: <?php echo e(\Carbon\Carbon::parse($lembaga->informasi->tanggal_update ?? now())->format('d M Y')); ?></p>
                <a href="<?php echo e(route('informasi.index')); ?>" class="inline-flex items-center gap-2 text-blue-600 text-sm mt-3 hover:underline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sirela\resources\views/lembaga/dashboard.blade.php ENDPATH**/ ?>