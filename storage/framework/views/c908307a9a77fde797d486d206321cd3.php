...
<div class="p-6 max-w-6xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
        <div class="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-600 px-6 py-5">
            <div class="flex flex-wrap justify-between items-start gap-3">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-2xl font-bold text-white"><?php echo e($lembaga['nama_lembaga']); ?></h1>
                </div>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="mb-6 p-4 rounded-xl <?php echo e($statusKolab == 'dibuka' ? 'bg-green-50 border border-green-200' : ($statusKolab == 'ditutup' ? 'bg-gray-50 border border-gray-200' : 'bg-yellow-50 border border-yellow-200')); ?>">
            ...
            <!-- Info Rekening Bank -->
            <?php if(isset($lembaga['user']) && ($lembaga['user']->rekening_lembaga || $lembaga['user']->rekening_komunitas)): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div class="flex items-start gap-3 p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 font-medium"><?php echo e($lembaga['user']->rekening_lembaga ?? $lembaga['user']->rekening_komunitas ?? 'Belum diisi'); ?></p>
                    </div>
                </div>
                <div class="flex items-start gap-3 p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 font-medium"><?php echo e($lembaga['user']->bank_name ?? $lembaga['user']->bank_name_komunitas ?? 'Belum diisi'); ?></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="mb-6">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-100">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if(isset($lembaga['kategori']) && count($lembaga['kategori']) > 0): ?>
                            <?php $__currentLoopData = $lembaga['kategori']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 px-3 py-1.5 rounded-full text-sm font-medium">
                                    <i class="fas fa-tag mr-1 text-blue-500 text-xs"></i> <?php echo e($kat['nama_kategori']); ?>
            ...
            <!-- VISI, MISI, DESKRIPSI -->
            <?php if(isset($lembaga['visi']) && !empty($lembaga['visi'])): ?>
            <div class="mb-4 p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl">
                ...
                <p class="text-gray-700"><?php echo e($lembaga['visi']); ?></p>
            </div>
            <?php endif; ?>
            
            <?php if(isset($lembaga['misi']) && !empty($lembaga['misi'])): ?>
            <div class="mb-4 p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl">
                ...
                <p class="text-gray-700"><?php echo e($lembaga['misi']); ?></p>
            </div>
            <?php endif; ?>
            
            <?php if(isset($lembaga['deskripsi']) && !empty($lembaga['deskripsi'])): ?>
            <div class="mb-4 p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl">
    ...
    <?php if(isset($lembaga['informasi']) && $lembaga['informasi']): ?>
    <?php 
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 text-center border border-blue-200">
                    ...
                    <p class="text-3xl font-bold text-blue-600"><?php echo e($info['jumlah_anak_asuh'] ?? 0); ?></p>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl p-4 text-center border border-emerald-200">
                    ...
                    <p class="text-3xl font-bold text-emerald-600"><?php echo e($info['rentang_usia'] ?? '-'); ?></p>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 text-center border border-purple-200">
                    ...
                    <p class="text-base font-bold text-purple-600">📅 <?php echo e(isset($info['tanggal_update']) && $info['tanggal_update'] ? date('d M Y', strtotime($info['tanggal_update'])) : '-'); ?></p>
                    <p class="text-gray-600 text-sm">Terakhir Update</p>
                </div>
            </div>
            <?php if(isset($info['profil_anak']) && !empty($info['profil_anak'])): ?>
            <div class="mt-5 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200">
                <div class="flex items-start gap-3"><div class="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center"><i class="fas fa-file-alt text-blue-500"></i></div><div><p class="text-sm font-semibold text-gray-700 mb-1">Deskripsi Anak Asuh</p><p class="text-gray-600 leading-relaxed"><?php echo e($info['profil_anak']); ?></p></div></div>
            </div>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="p-6">
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $donasiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="border border-gray-300 px-4 py-2"><?php echo e($item['nama'] ?? '-'); ?></td>
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                <?php if($jenis == 'uang'): ?>
                                    Rp <?php echo e(number_format($target, 0, ',', '.')); ?>

                                <?php else: ?>
                                    <?php echo e(number_format($target, 0, ',', '.')); ?> <?php echo e($item['satuan'] ?? 'unit'); ?>
                            ...
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                ...
                                <?php else: ?>
                                    <?php echo e(number_format($terkumpul, 0, ',', '.')); ?> <?php echo e($item['satuan'] ?? 'unit'); ?>

                                <?php endif; ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-2 text-center"><?php echo e($item['satuan'] ?? ($jenis == 'uang' ? 'Rupiah' : 'unit')); ?></td>
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                <div class="w-full bg-gray-200 rounded-full h-2.5">
                                    <div class="bg-green-600 rounded-full h-2.5" style="width: <?php echo e($persen); ?>%"></div>
                                </div>
                                <span class="text-xs text-gray-500"><?php echo e($persen); ?>%</span>
                            </td>
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                <?php $prioritas = $item['prioritas'] ?? 'sedang'; ?>
                                <?php if($prioritas == 'tinggi'): ?> <span class="bg-red-100 text-red-700 px-2 py-1 rounded-full text-xs">Tinggi</span>
                                <?php elseif($prioritas == 'rendah'): ?> <span class="bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs">Rendah</span>
                                <?php else: ?> <span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full text-xs">Sedang</span>
                                <?php endif; ?>
                            </td>
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                <?php if($terpenuhi): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <button onclick="bukaModalDonasi(
                                        '<?php echo e($info['informasi_id']); ?>', 
                                        '<?php echo e($lembaga['lembaga_id']); ?>', 
                                        '<?php echo e($item['id'] ?? $index); ?>', 
                                        '<?php echo e(addslashes($item['nama'])); ?>', 
                                        '<?php echo e($item['satuan'] ?? 'unit'); ?>', 
                                        '<?php echo e($jenis); ?>',
                                        '<?php echo e(addslashes($bankName)); ?>',
                                        '<?php echo e(addslashes($rekening)); ?>'
                                    )"
...
<div id="modalDonasi" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 hidden">
    <div class="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('donasi.store')); ?>" method="POST" id="formDonasiPublik" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sirela\resources\views/public/show.blade.php ENDPATH**/ ?>