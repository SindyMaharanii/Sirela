                ...
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border border-gray-300 px-4 py-2 text-center"><?php echo e($item['target'] ?? $item['jumlah'] ?? 0); ?></td>
                            <td class="border border-gray-300 px-4 py-2 text-center"><?php echo e($item['satuan'] ?? 'unit'); ?></td>
                            ...
                            <td class="border border-gray-300 px-4 py-2 text-center">
                                <button onclick="bukaModalDonasi('<?php echo e($info['informasi_id']); ?>', '<?php echo e($lembaga['lembaga_id']); ?>', '<?php echo e($item['id'] ?? $index); ?>', '<?php echo e(addslashes($item['nama'])); ?>', '<?php echo e($item['satuan'] ?? 'unit'); ?>')"
