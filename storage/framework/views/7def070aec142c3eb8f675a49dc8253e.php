...
<div class="p-6">
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <select name="bulan" class="w-full border rounded-lg px-3 py-2">
                    <option value="1" <?php echo e(($bulan ?? date('m')) == '1' ? 'selected' : ''); ?>>Januari</option>
                    <option value="2" <?php echo e(($bulan ?? date('m')) == '2' ? 'selected' : ''); ?>>Februari</option>
                    <option value="3" <?php echo e(($bulan ?? date('m')) == '3' ? 'selected' : ''); ?>>Maret</option>
                    <option value="4" <?php echo e(($bulan ?? date('m')) == '4' ? 'selected' : ''); ?>>April</option>
                    <option value="5" <?php echo e(($bulan ?? date('m')) == '5' ? 'selected' : ''); ?>>Mei</option>
                    <option value="6" <?php echo e(($bulan ?? date('m')) == '6' ? 'selected' : ''); ?>>Juni</option>
                    <option value="7" <?php echo e(($bulan ?? date('m')) == '7' ? 'selected' : ''); ?>>Juli</option>
                    <option value="8" <?php echo e(($bulan ?? date('m')) == '8' ? 'selected' : ''); ?>>Agustus</option>
                    <option value="9" <?php echo e(($bulan ?? date('m')) == '9' ? 'selected' : ''); ?>>September</option>
                    <option value="10" <?php echo e(($bulan ?? date('m')) == '10' ? 'selected' : ''); ?>>Oktober</option>
                    <option value="11" <?php echo e(($bulan ?? date('m')) == '11' ? 'selected' : ''); ?>>November</option>
                    <option value="12" <?php echo e(($bulan ?? date('m')) == '12' ? 'selected' : ''); ?>>Desember</option>
                </select>
            </div>
            <div>
                ...
                <select name="tahun" class="w-full border rounded-lg px-3 py-2">
                    <?php $__currentLoopData = $tahunList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($thn); ?>" <?php echo e(($tahun ?? date('Y')) == $thn ? 'selected' : ''); ?>><?php echo e($thn); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="flex items-end gap-2">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg">Tampilkan</button>
                <a href="<?php echo e(route('laporan.download-excel', request()->all())); ?>" class="bg-green-500 text-white px-4 py-2 rounded-lg">Excel</a>
                <a href="<?php echo e(route('laporan.download-pdf', request()->all())); ?>" class="bg-red-500 text-white px-4 py-2 rounded-lg">PDF</a>
            </div>
        </form>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-4 text-white shadow-md flex flex-col">
            ...
            <div class="flex items-center justify-between">
                <p class="text-4xl font-extrabold"><?php echo e(number_format($totalTarget, 0, ',', '.')); ?></p>
        ...
        <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl p-4 text-white shadow-md flex flex-col">
            ...
            <div class="flex items-center justify-between">
                <p class="text-4xl font-extrabold"><?php echo e(number_format($totalTerkumpul, 0, ',', '.')); ?></p>
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-4 text-white shadow-md flex flex-col">
            ...
            <div class="flex items-center justify-between">
                <p class="text-4xl font-extrabold">Rp <?php echo e(number_format($totalDonasiUang, 0, ',', '.')); ?></p>
        ...
        <div class="bg-gradient-to-r from-cyan-500 to-cyan-600 rounded-xl p-4 text-white shadow-md flex flex-col">
            ...
            <div class="flex items-center justify-between">
                <p class="text-4xl font-extrabold"><?php echo e(number_format($totalDonasiBarang, 0, ',', '.')); ?></p>
        ...
        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-4 text-white shadow-md flex flex-col">
            ...
            <div class="flex items-center justify-between">
                <p class="text-4xl font-extrabold"><?php echo e($totalDonatur); ?></p>
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-4 text-white shadow-md flex flex-col">
            ...
            <div class="flex items-center justify-between">
                <p class="text-4xl font-extrabold"><?php echo e(min($persentase, 100)); ?>%</p>
                <i class="fas fa-chart-line text-6xl opacity-40"></i>
            </div>
            <div class="mt-3">
                <div class="w-full bg-white/30 rounded-full h-2">
                    <div class="bg-white rounded-full h-2 transition-all duration-500" style="width: <?php echo e(min($persentase, 100)); ?>%"></div>
                </div>
                <p class="text-[11px] mt-1 opacity-80 text-right">
                    <?php echo e($persentase >= 100 ? '🎉 Target Tercapai!' : 'Sisa ' . number_format(max(0, $totalTarget - $totalTerkumpul), 0, ',', '.')); ?>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <div class="bg-gradient-to-r from-[#0f2b5c] via-[#1e3a8a] to-[#2563eb] px-5 py-3">
            ...
            <p class="text-blue-100 text-sm">Periode: <?php echo e($namaBulan); ?> <?php echo e($tahun); ?></p>
        </div>
            ...
            <table class="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border px-4 py-2"><?php echo e($d->created_at->format('d/m/Y H:i')); ?></td>
                        <td class="border px-4 py-2"><?php echo e($d->nama_donatur); ?></td>
                        <td class="border px-4 py-2"><?php echo e($d->kebutuhan_nama); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sirela\resources\views/laporan/index.blade.php ENDPATH**/ ?>