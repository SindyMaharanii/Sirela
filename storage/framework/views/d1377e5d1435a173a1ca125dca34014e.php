                ...
                <div class="p-8">
                    ...
                    <form method="POST" action="<?php echo e(route('password.email')); ?>">
                        ...
                        <div class="text-center mt-6 pt-4 border-t">
                            <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium inline-flex items-center gap-1">
...
</html><?php /**PATH C:\xampp\htdocs\Sirela\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>