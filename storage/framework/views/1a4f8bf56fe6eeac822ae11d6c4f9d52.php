...
<head>
    ...
    <title><?php echo e(config('app.name', 'SISOREL')); ?> - Platform Informasi Sosial</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="py-4">
        ...
        <?php elseif(auth()->user()->role == 'lembaga'): ?>
            ...
            <?php if($lembagaId): ?>
                <a href="<?php echo e(route('lembaga.show', $lembagaId)); ?>" class="nav-item <?php echo e(request()->routeIs('lembaga.show') ? 'active' : ''); ?>">
