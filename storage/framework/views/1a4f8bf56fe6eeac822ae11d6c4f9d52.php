...
<head>
    ...
    <title><?php echo e(config('app.name', 'SIRELA')); ?> - Platform Informasi Sosial</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="py-4">
        ...
        <?php if(auth()->user()->role == 'admin'): ?>
            ...
            <a href="<?php echo e(route('lembaga.index')); ?>" class="nav-item <?php echo e(request()->routeIs('lembaga.*') || request()->routeIs('verifikasi') ? 'active' : ''); ?>">
                ...
                <?php if($pendingCount > 0): ?>
                    <span class="ml-auto bg-red-500 text-white text-[10px] px-2 py-0.5 rounded-full"><?php echo e($pendingCount); ?></span>
                <?php endif; ?>
            </a>
...
?>
            ...
            <a href="<?php echo e(route('donasi.index')); ?>" class="nav-item <?php echo e(request()->routeIs('donasi.*') ? 'active' : ''); ?>">
                ...
                <?php if($pendingDonasiCount > 0): ?>
                    <span class="ml-auto bg-red-500 text-white text-[10px] px-2 py-0.5 rounded-full"><?php echo e($pendingDonasiCount); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('laporan.index')); ?>" class="nav-item <?php echo e(request()->routeIs('laporan.index') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('register')); ?>" class="nav-item btn-register">
...
</html><?php /**PATH C:\xampp\htdocs\Sirela\resources\views/layouts/app.blade.php ENDPATH**/ ?>