...
<div class="p-6">
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        <form action="<?php echo e(route('informasi.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <!-- Jumlah Anak Asuh -->
            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-2">Jumlah Anak Asuh</label>
                <input type="number" name="jumlah_anak_asuh" value="<?php echo e(old('jumlah_anak_asuh')); ?>" 
            ...
            <div class="mb-4">
                ...
                <input type="text" name="rentang_usia" value="<?php echo e(old('rentang_usia')); ?>" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" 
            ...
            <div class="mb-4">
                ...
                <textarea name="profil_anak" rows="3" 
                          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Deskripsi singkat tentang anak asuh"><?php echo e(old('profil_anak')); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sirela\resources\views\informasi\create.blade.php ENDPATH**/ ?>