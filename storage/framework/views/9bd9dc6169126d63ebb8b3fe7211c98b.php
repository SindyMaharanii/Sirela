        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
            ...
            <div class="group relative overflow-hidden rounded-2xl p-5 text-center text-white shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 cursor-pointer">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-3xl font-bold"><?php echo e(\App\Models\Lembaga::whereHas('user', function($q){ $q->where('status_akun', 'aktif'); })->count()); ?></p>
            ...
            <div class="group relative overflow-hidden rounded-2xl p-5 text-center text-white shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 cursor-pointer">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-3xl font-bold"><?php echo e(\App\Models\InformasiLembaga::whereNotNull('kebutuhan_donasi_list')->count()); ?></p>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="bg-white rounded-2xl shadow-md p-5 mb-8 border border-blue-100">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <select id="filterKategori" class="border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <?php $__currentLoopData = \App\Models\Kategori::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($kat->nama_kategori); ?>"><?php echo e($kat->nama_kategori); ?></option>
                ...
                <select id="filterLokasi" class="border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <?php $__currentLoopData = \App\Models\Lembaga::whereNotNull('lokasi')->distinct()->pluck('lokasi'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($lok); ?>"><?php echo e($lok); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="lembagaContainer">
            ...
            <div class="group bg-white rounded-2xl shadow-md overflow-hidden border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-2 lembaga-card"
                 ...
                 data-kategori="<?php $__currentLoopData = $item->kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e(strtolower($kat->nama_kategori)); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>"
                 data-lokasi="<?php echo e(strtolower($item->lokasi ?? '')); ?>"
                 data-kolaborasi="<?php echo e($item->informasi->status_kolaborasi ?? ''); ?>">
                <div class="p-5">
                    <div class="flex justify-between items-start mb-3">
                        <h3 class="text-xl font-bold text-gray-800 group-hover:text-blue-600 transition"><?php echo e($item->nama_lembaga); ?></h3>
                        <div class="flex gap-1 flex-wrap">
                            <?php $__currentLoopData = $item->kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="bg-blue-100 text-blue-700 text-xs px-2 py-1 rounded-full"><?php echo e($kat->nama_kategori); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <p class="text-gray-500 text-sm mb-2"><i class="fas fa-map-marker-alt mr-2 text-blue-500"></i> <?php echo e($item->lokasi ?? $item->alamat ?? 'Tidak tersedia'); ?></p>
                    <p class="text-gray-500 text-sm mb-3"><i class="fas fa-phone mr-2 text-blue-500"></i> <?php echo e($item->kontak ?? 'Tidak tersedia'); ?></p>
                    <?php if($item->informasi): ?>
                        <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-3 mb-3">
                            <p class="text-sm text-gray-600"><i class="fas fa-child mr-1 text-blue-500"></i> Jumlah Anak: <span class="font-semibold"><?php echo e($item->informasi->jumlah_anak_asuh ?? 0); ?></span></p>
                            <p class="text-sm text-gray-600 mt-1">
                                <i class="fas fa-handshake mr-1"></i> Status: 
                                <?php if(($item->informasi->status_kolaborasi ?? '') == 'dibuka'): ?>
                    ...
                    <?php endif; ?>
                    <a href="/public/lembaga/<?php echo e($item->lembaga_id); ?>" class="inline-flex items-center gap-2 text-blue-600 font-medium hover:text-blue-800 transition group-hover:gap-3">
...
<section class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl text-white py-12 mb-8">
    <div class="container mx-auto px-6 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="<?php echo e(route('register')); ?>" class="register-btn inline-flex items-center gap-2 px-8 py-3.5 rounded-xl font-bold transition-all hover:scale-105">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sirela\resources\views/index.blade.php ENDPATH**/ ?>