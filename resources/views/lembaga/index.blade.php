...
@endphp
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl p-4 text-white shadow">
                ...
                <p class="text-2xl font-bold">{{ $lembagaNonaktif }}</p>
            </div>
        </div>
                ...
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-blue-50 transition">
                            ...
                            <td class="border border-gray-300 px-4 py-3 text-center">
                                <button onclick="showDetail({{ $item->user->id }})" 
                            ...
                            <td class="border border-gray-300 px-4 py-3 text-center">
                                @if($item->user && $item->user->status_akun == 'nonaktif')
                                <form action="{{ route('verifikasi.toggle', $item->user->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PUT')
                                ...
                                @elseif($item->user && $item->user->status_akun == 'aktif')
                                <form action="{{ route('verifikasi.toggle', $item->user->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PUT')
