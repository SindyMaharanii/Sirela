...
<div class="max-w-5xl mx-auto">
        ...
        <div class="relative z-10">
            <div class="flex justify-center mb-4">
                <div class="flex gap-2">
                                    <div class="w-2 h-2 bg-cyan-300 rounded-full animate-ping"></div>
                    <div class="w-2 h-2 bg-blue-300 rounded-full animate-ping delay-100"></div>
                    <div class="w-2 h-2 bg-indigo-300 rounded-full animate-ping delay-200"></div>
                </div>
            </div>
            ...
            <p class="text-white leading-relaxed text-center text-lg">
                ...
                profil, kebutuhan donasi, dan status kolaborasi secara 
                <span class="text-cyan-200 font-semibold border-b border-cyan-300/50">terstruktur dan transparan</span>.
            </p>
            <div class="flex justify-center mt-5">
                <div class="flex gap-1">
                    <div class="w-8 h-0.5 bg-cyan-300/50 rounded-full"></div>
                    <div class="w-8 h-0.5 bg-blue-300/50 rounded-full"></div>
                    <div class="w-8 h-0.5 bg-indigo-300/50 rounded-full"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <!-- Visi Card - Biru Muda dengan efek -->
        <div class="group relative overflow-hidden bg-gradient-to-br from-blue-100 via-blue-50 to-white rounded-xl p-6 border border-blue-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
            <div class="absolute top-0 left-0 w-40 h-40 bg-gradient-to-br from-blue-300 to-cyan-200 rounded-br-3xl opacity-30 group-hover:scale-150 transition-transform duration-500"></div>
            <div class="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-tl from-indigo-200 to-transparent rounded-tl-3xl opacity-20"></div>
            <div class="absolute -top-5 -right-5 w-16 h-16 bg-blue-400/10 rounded-full blur-xl"></div>
            <div class="relative z-10">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition duration-300 group-hover:shadow-blue-500/30">
                        <i class="fas fa-eye text-white text-xl"></i>
                    </div>
                    <div>
                        <h2 class="text-xl font-bold bg-gradient-to-r from-blue-700 to-indigo-700 bg-clip-text text-transparent">Visi</h2>
                        <div class="w-10 h-0.5 bg-gradient-to-r from-blue-400 to-transparent rounded-full mt-1"></div>
                    </div>
                </div>
                ...
                <div class="mt-4 flex justify-end">
                    <div class="w-12 h-0.5 bg-gradient-to-r from-blue-300 to-transparent rounded-full"></div>
                </div>
            </div>
        </div>
        <!-- Misi Card - Biru Tua dengan efek -->
        <div class="group relative overflow-hidden bg-gradient-to-br from-indigo-100 via-indigo-50 to-white rounded-xl p-6 border border-indigo-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
            ...
            <div class="absolute -bottom-5 -left-5 w-16 h-16 bg-indigo-400/10 rounded-full blur-xl"></div>
            <div class="relative z-10">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition duration-300 group-hover:shadow-indigo-500/30">
                        <i class="fas fa-bullseye text-white text-xl"></i>
                    </div>
                    <div>
                        <h2 class="text-xl font-bold bg-gradient-to-r from-indigo-700 to-blue-700 bg-clip-text text-transparent">Misi</h2>
                        <div class="w-10 h-0.5 bg-gradient-to-r from-indigo-400 to-transparent rounded-full mt-1"></div>
                    </div>
                </div>
                <ul class="space-y-2">
                    <li class="flex items-start gap-2 group/misi">
                        <div class="w-5 h-5 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 group-hover/misi:scale-110 transition">
                            <i class="fas fa-check text-white text-[10px]"></i>
                        </div>
                        <span class="text-indigo-800/70 text-sm">Memudahkan lembaga sosial dalam mempublikasikan informasi</span>
                    </li>
                    <li class="flex items-start gap-2 group/misi">
                        <div class="w-5 h-5 bg-cyan-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 group-hover/misi:scale-110 transition">
                            <i class="fas fa-check text-white text-[10px]"></i>
                        </div>
                    ...
                    <li class="flex items-start gap-2 group/misi">
                        ...
                        <span class="text-indigo-800/70 text-sm">Meningkatkan transparansi kegiatan sosial</span>
                    </li>
                    <li class="flex items-start gap-2 group/misi">
                        <div class="w-5 h-5 bg-cyan-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 group-hover/misi:scale-110 transition">
                            <i class="fas fa-check text-white text-[10px]"></i>
                ...
                <div class="mt-4 flex justify-end">
                    <div class="w-12 h-0.5 bg-gradient-to-r from-indigo-300 to-transparent rounded-full"></div>
                </div>
            </div>
        </div>
    </div>

    <!-- Fitur Unggulan dengan Nuansa Biru Mewah -->
    <div class="bg-gradient-to-br from-white via-blue-50/50 to-white rounded-2xl shadow-xl border border-blue-100 p-6 mb-8 relative overflow-hidden">
        <div class="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-cyan-100 to-transparent rounded-bl-full opacity-50"></div>
        <div class="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-indigo-100 to-transparent rounded-tr-full opacity-30"></div>
        <div class="relative z-10">
            <div class="text-center mb-6">
                <div class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-cyan-100 px-4 py-2 rounded-full shadow-inner">
                    ...
                    <span class="text-sm font-semibold text-blue-700">Fitur Premium</span>
                    <i class="fas fa-star text-blue-500 text-sm"></i>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="flex items-start gap-3 p-3 bg-gradient-to-r from-blue-100/60 to-transparent rounded-xl hover:from-blue-200/70 transition-all duration-300 group cursor-pointer">
                    <div class="w-7 h-7 bg-blue-500 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition shadow-md">
                        <i class="fas fa-check text-white text-xs"></i>
                    </div>
                    <span class="text-sm text-blue-800">Pencarian & filter lembaga berdasarkan kategori, lokasi, dan status kolaborasi</span>
                </div>
                <div class="flex items-start gap-3 p-3 bg-gradient-to-r from-cyan-100/60 to-transparent rounded-xl hover:from-cyan-200/70 transition-all duration-300 group cursor-pointer">
                    <div class="w-7 h-7 bg-cyan-500 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition shadow-md">
                        <i class="fas fa-check text-white text-xs"></i>
                    </div>
                    <span class="text-sm text-cyan-800">Verifikasi akun lembaga oleh admin untuk menjaga kredibilitas</span>
                </div>
                <div class="flex items-start gap-3 p-3 bg-gradient-to-r from-indigo-100/60 to-transparent rounded-xl hover:from-indigo-200/70 transition-all duration-300 group cursor-pointer">
                    <div class="w-7 h-7 bg-indigo-500 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition shadow-md">
                        <i class="fas fa-check text-white text-xs"></i>
                    </div>
                    <span class="text-sm text-indigo-800">Lembaga dapat mengelola profil dan informasi donasi secara mandiri</span>
                </div>
                <div class="flex items-start gap-3 p-3 bg-gradient-to-r from-blue-100/60 to-transparent rounded-xl hover:from-blue-200/70 transition-all duration-300 group cursor-pointer">
                    <div class="w-7 h-7 bg-blue-500 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition shadow-md">
                        <i class="fas fa-check text-white text-xs"></i>
                    </div>
                    <span class="text-sm text-blue-800">Privasi data anak asuh terjaga (hanya data agregat yang ditampilkan)</span>
                </div>
            </div>
        </div>
    </div>

    <!-- Kontak dengan Desain Biru Kreatif Mewah -->
    <div class="text-center">
        <div class="inline-flex items-center gap-5 bg-gradient-to-r from-white via-blue-50/50 to-white rounded-full px-6 py-3 shadow-lg border border-blue-200 hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <div class="text-left">
                ...
                <a href="mailto:support@sisorel.com" class="text-blue-600 font-semibold text-sm hover:underline">maharanisindy@gmail.com</a>
            </div>
            <div class="w-px h-8 bg-gradient-to-b from-blue-200 to-cyan-200"></div>
            <div class="flex gap-2">
                <a href="https://www.instagram.com/shennnd?igsh=MTc1MDF1YWR3Ynoyag==" class="w-9 h-9 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-all shadow-md group">
                    <i class="fab fa-instagram text-white text-sm group-hover:rotate-12 transition"></i>
                </a>
                <a href="#" class="w-9 h-9 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-full flex items-center justify-center hover:scale-110 transition-all shadow-md group">
                    <i class="fab fa-facebook-f text-white text-sm group-hover:rotate-12 transition"></i>
                </a>
                <a href="#" class="w-9 h-9 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-full flex items-center justify-center hover:scale-110 transition-all shadow-md group">
                    <i class="fab fa-twitter text-white text-sm group-hover:rotate-12 transition"></i>
                </a>
            </div>
        </div>
